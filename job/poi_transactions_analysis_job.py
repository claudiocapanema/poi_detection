...
class PoiTransactionsAnalysisJob:
    ...
    def start(self):
        ...
        transactions_filename = Input.get_instance().inputs['filename']
        ...
        dataset_columns = self.next_poi_category_prediction_configuration.DATASET_COLUMNS[1][dataset_name]
        ...
        if generate_file != "no":
            df_transactions = self.poi_transactions_domain.get_transactions(df_transactions, dataset_columns, country, state, county)
