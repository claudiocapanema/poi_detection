...
GOWALLA_US_SEQUENCES="${GOWALLA_BASE_DIR}sequences_utilizado_no_pewasun/gowalla_7_categories_sequences.csv"
...
SEQUENCE_GENERATION_FOR_POI_CATEGORIZATION_SEQUENTIAL_CONFIG='{
          ...
          "users_steps_filename": "'$USER_TRACKING_HOME_WORK_OTHER_AND_GOWALLA_CATEGORIES'",
          "base_dir":"'$USERS_STEPS_BASE_DIR'",
          "users_sequences_folder":"'$USERS_STEPS_OUTPUT_BASE_DIR'sequences/",
          "8_categories_filename":"'$USER_TRACKING_HOME_WORK_OTHER_AND_GOWALLA_CATEGORIES'",
