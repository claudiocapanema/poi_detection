...
class MFA_RNN(NNBase):
    ...
    def build(self, step_size, location_input_dim, time_input_dim, num_users, seed=None):
        ...
        poi_category_probabilities = Input((step_size, location_input_dim), dtype='float32',
                                           name='poi_category_probabilities')
        directed_adjancency_matrix = Input((location_input_dim, location_input_dim), dtype='float32',
                                           name='directed_adjacency_matrix')
